...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsor) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(10...500))}
  ...
  describe "SPONSORED POST create" do
    it "increases the number of Sponsored Post by 1" do
        expect{post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(10...500)}}.to change(SponsoredPost,:count).by(1)
      end
      
    it "assigns the new sponsored post to @sponsored_post" do
      post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(10...500)}
  ...
  describe "GET edit" do
    ...
    it "assigns sponsored post to be updated to @sponsored_post" do
      ...
      expect(sponsored_post_instance.id).to eq my_sponsor.id
      expect(sponsored_post_instance.title).to eq my_sponsor.title
      expect(sponsored_post_instance.body).to eq my_sponsor.body
    end
  end
